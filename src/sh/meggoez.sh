...
read x;
cd $HOME
wget https://github.com/eggheads/eggdrop/releases/download/v1.8.2/eggdrop-1.8.2.tar.gz && tar zxf eggdrop-1.8.2.tar.gz && rm -rf eggdrop-1.8.2.tar.gz && mv eggdrop* eggoez && cd eggoez && ./configure && make config && make && make install DEST=~/.eggoez && cd ~/.eggoez && wget http://berkas.eggoez.com/repo/src/eggoez17-tcl.tar.gz && tar zxf eggoez17-tcl.tar.gz && mkdir data && mv eggdrop goez && wget https://raw.githubusercontent.com/eg-goez/.eggoez/master/conf/egg.conf
